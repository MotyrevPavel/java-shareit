...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDto getById(Long bookingId, Long userId) {
        ...
        if (!Objects.equals(itemOwnerId, userId) && !Objects.equals(bookerId, userId)) {
            ...
            throw new NotFoundException("У вас нет доступа для просмотра информации по этому бронированию");
        }
        BookingDto bookingDto = BookingMapper.toBookingDto(booking);
    ...
    public List<BookingDto> getAllBookingsByOwner(Long ownerId, BookingState state) {
        ...
        if (!userRepository.existsById(ownerId)) {
            ...
            throw new NotFoundException("Не найден пользователь по ID " + ownerId);
        }
